...
- Otwieranie odtwarzacza muzyki przy podłączaniu słuchawek
- Wydłużanie czasu działania telefonu, gdy go nie używasz
... i wiele więcej!

Situations pomaga pozbyć się rutynowych czynności, wykonując je automatycznie za Ciebie.

Aplikacja zawiera wszechstronny zbiór domyślnej funkcjonalności. Większa jej ilość (zarówno darmowa, jak i płatna), może zostać zainstalowana wprost z aplikacji. Co więcej, stale dodawane sa kolejne rozszerzenia!

W związku z zasadą działania aplikacji, wymagana jest znaczna ilość uprawnień systemowych. Aplikacja w żaden sposób nie zbiera danych o użytkowniku, ani innych. Sprawdź naszą politykę prywatności, aby dowiedzieć się więcej.

Ta wersja językowa dostarczona jest przez InYourHead (https://github.com/InYourHead).
W związku z ciągłym rozwojem aplikacji, część funkcjonalności może być nieprzetłumaczona.
        </translation>
    </message>
    <message id="promo">
