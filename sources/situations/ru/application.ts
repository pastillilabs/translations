...
the app!</translation>
    ...
    <message id="situation_name">
        ...
        <translation>Название ситуации</translation>
    </message>
    <message id="no_icon">
...
Situations application processes all data locally by default and everything remains in full user control.</source>
        <translation>Pastilli Labs вообще не собирает и не передаёт третьим лицам никакую пользовательскую и прочую информацию.

Приложение Situations по умолчанию обрабатывает все данные локально и под полным пользовательским управлением.</translation>
    </message>
    ...
    <message id="translation_updated">
        ...
        <translation>Язык приложения обновлён!&lt;br&gt;&lt;br&gt;ПОМНИТЕ: Части приложения могу быть переведены не полностью. Подробнее здесь:&lt;br&gt;%1</translation>
    </message>
    <message id="translation_not_available">
        ...
        <translation>Невозможно обновить или приложение ещё не переведено на ваш язык.&lt;br&gt;&lt;br&gt;Поддержите нас и других пользователей приложения, предоставив перевод здесь:&lt;br&gt;%1</translation>
    </message>
    <message id="restart_required">
        <source>Situations needs to be restarted.

Restart now?</source>
        <translation>Необходимо перезапустить Situations.
